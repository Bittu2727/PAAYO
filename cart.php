...
<section class="shopping-cart">
   ...
   <form action="" method="POST" class="box">
      <a href="cart.php?delete=<?= htmlspecialchars($fetch_cart['cart_id']); ?>" class="fas fa-times" onclick="return confirm('Delete Booking?');"></a>
   ...
   <div class="cart-total">
      ...
      <a href="shop.php" class="option-btn">Other Booking</a>
      <a href="cart.php?delete_all" class="delete-btn <?= ($grand_total > 0) ? '' : 'disabled'; ?>">Delete All</a>
      <a href="checkout.php" class="btn <?= ($grand_total > 0) ? '' : 'disabled'; ?>">Proceed to Book</a>
   </div>
</section>
